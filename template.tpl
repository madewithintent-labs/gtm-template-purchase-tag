...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Made with Intent Purchase",
  ...
  "description": "Fire this tag when an order is placed",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    ...
    "subParams": [
      ...
      },
      {
        ...
        "simpleValueType": true,
        "help": "An array of the type [ { product_id: SKU, item_value: VALUE, item_quantity: QUANTITY,       item_discount_value: DISCOUNT}, ... ];"
      }
    ]
  }
]
...
Created on 19/03/2024, 11:37:58
